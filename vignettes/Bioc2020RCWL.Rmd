...
downstream data analysis. The support for integration of _R_ functions
in `Rcwl` is a very unique feature, where we can easily connect the
upstream data preprocessing steps (previously based on command line
tools) and the downstream data analysis steps.
