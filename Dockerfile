...
RUN apt-get update && \
    apt-get install -y libglpk-dev python3-pip build-essential libssl-dev uuid-dev libgpgme11-dev squashfs-tools libseccomp-dev wget pkg-config git cryptsetup && \
    apt-get clean && \
